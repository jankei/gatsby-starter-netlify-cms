...
const CustomSkinMap = withScriptjs(
  withGoogleMap(props => (
    <GoogleMap
      defaultZoom={15}
      defaultCenter={{ lat: 32.473567, lng: 34.99343 }}
      defaultOptions={{
        scrollwheel: false,
        zoomControl: true,
        styles: [
    ...
    >
      <Marker position={{ lat: 32.473567, lng: 34.99343 }} />
    </GoogleMap>
  ))
);
    ...
    return (
      <div>
        ...
        <div className={classes.bigMap}>
          <CustomSkinMap
            googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyDMn2u-vYcLIVWLWaeodI3h_qXZmlnc6-M"
              ...
              <GridContainer>
                ...
                <GridItem md={4} sm={4} className={classes.mlAuto}>
                  <InfoArea
                    ...
                    description={
                      <p>
                        המושב 42 כרכור, במרכז "בית אורן"
                        <br />
                        כניסה אחורית של הבניין (קומת קרקע) מאחורי מאפיית אגמיאו
                        <br />
                        קרוספיט פרדס חנה כרכור בוויז
                      </p>
                    }
                    icon={PinDrop}
                    iconColor="primary"
